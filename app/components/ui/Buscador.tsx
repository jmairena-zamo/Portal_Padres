...
export default function Buscador<T>({ datos, campos, placeholder = "Buscar...", onResultado }: BuscadorProps<T>) {
    ...
    return (
        <div className="relative flex items-center w-full">
            ...
            <input
                type="text"
                className="w-full px-8 py-[7px] border border-black rounded-md text-[14px] outline-none transition-colors duration-200 focus:border-[#005221] focus:shadow-[0_0_0_2px_rgba(0,130,55,0.15)]"
