        ...
        <div className="flex justify-between items-center gap-5 px-4 py-3
            ...
            <div className="flex items-center gap-[18px] flex-wrap
                ...
                <div className="flex items-center gap-2 text-[13px] text-[#888]
                    ...
                    <select
                        ...
                        className="px-2 py-1 rounded-md border border-[#c8e6c9]
                            text-[#2e7d32] text-[13px] cursor-pointer outline-none"
                    >
            ...
            <div className="flex items-center gap-1.5 flex-wrap
                ...
                <button
                    ...
                    className="px-3 py-1.5 rounded-md border border-[#c8e6c9]
                    ...
                    <button
                        ...
                        className={[
                            ...
                            pagina === paginaActual
                                ...
                                : 'bg-white text-[#2e7d32] border-[#c8e6c9]',
                        ].join(' ')}
                    >
                        {pagina}
                    </button>
